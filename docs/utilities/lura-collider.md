...
高さを変更したときの見た目が**いい感じ**にアニメーションします。

単なるコライダーの切り替えではなく、視覚的にも楽しめる演出付きです。
...
:::warning
**重要**: コライダーに乗った状態でスライダーを使う配置にスライダーをおくと、**自分が動いてしまって操作ができなくなってしまう**ので注意。

**スライダーはコライダーの範囲外に置きましょう。**
:::
