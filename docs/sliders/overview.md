...
スライダーは、連続的な値を調整するコンポーネントです。ライトの明るさ、音量、ミラーの解像度など、0〜100%の範囲で調整できます。

## スライダーの特徴

### かっこいいデザイン

モダンでスタイリッシュなスライダーUIを採用しています。

### 10%スナップ機能

スライダーは **10%ずつにスナップ**する仕様です。
...
2DモードのスライダーはUnity標準のスライダーではなく、独自実装により**快適な操作感**を実現しています。
...
Verticalモードが使いにくい場合は、Horizontalモードに切り替えられます。
