...
**使い方**:
- LuraMirrorの `====MirrorActivator====` をTargetに指定することで、ミラー全体のオン/オフを切り替えます

**詳細**: [LuraMirror](../utilities/lura-mirror.md) のページを参照
...
**Switch_Audioとの違い**: より音楽再生に特化した制御が可能
